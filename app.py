...
def main():
    ...
    for word in words_result:
        ...
        # jika ini sebuah daftar string, maka akan mengambil string pertama dr daftar 
        words.append({
            'word': word['word'],
...
def save_word():
    ...
    return jsonify({
        'result': 'success',
        'msg': f'the word {word}, sudah disave!',
    })
...
def delete_ex():
    ...
    return jsonify({
        'result': 'success',
        'msg': f'Your word {word}, sudah terhapus!',
    })
